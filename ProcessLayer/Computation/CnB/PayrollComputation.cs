                ...
                while (start <= end)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                FlexiComputation(payroll, approvedotrequests, end, sched, starttime, breaktime, breaktimeend, endtime, startnight1, endnight1, startnight2, endnight2, details, LoginDate, LogoutDate, leave);
                            }
                            else //Regular Hours
                            {
