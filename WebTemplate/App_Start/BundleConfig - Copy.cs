...
namespace WebTemplate
{
    public class BundleConfig
    {
        ...
        {
            // JP Datetimepicker
            bundles.Add(new ScriptBundle("~/custom/jp-datetimepicker").Include(
                "~/Scripts/custom/datetimepicker-custom.js"
            ));
            bundles.Add(new StyleBundle("~/custom/datetimepickerstyle").Include(
                "~/Scripts/custom/jquery.datetimepicker/jquery.datetimepicker.css"));

            bundles.Add(new ScriptBundle("~/custom/helperFunctions").Include(
            ...
            //"~/Scripts/custom/custom-error-validation.js",
            //"~/Scripts/custom/custom-functions-floating-button.js",
            //"~/Scripts/custom/custom-functions-input.js",
            //"~/Scripts/custom/custom-functions.js",
            //"~/Scripts/custom/custom-spinner-settings.js",
            //"~/Scripts/custom/custom-follow-scroll.js"
            ));
            ...
            bundles.Add(new ScriptBundle("~/plugins/toastr").Include(
                      "~/Scripts/plugins/toastr/toastr.min.js").Include(
            ...
            // JQuery Webcam
            bundles.Add(new StyleBundle("~/plugins/jQuery-webcam-master").Include(
                        "~/Scripts/plugins/jQuery-webcam-master/jquery.webcam.js",
                        "~/Scripts/plugins/jQuery-webcam-master/jquery.webcam.min.js"));
            
            // AutoNumeric
            bundles.Add(new StyleBundle("~/plugins/autoNumeric").Include(
                        "~/Scripts/plugins/autoNumeric/autoNumeric.js"));

            // Mask Plugin
            bundles.Add(new ScriptBundle("~/plugins/maskPlugin").Include(
