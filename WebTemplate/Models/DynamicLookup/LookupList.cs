    ...
    public static class LookupHelper
    {
        ...
        public static readonly List<KeyValuePair<Lookups, List<LookupSetting>>> LookupListItems = new List<KeyValuePair<Lookups, List<LookupSetting>>>()
        {
            ...
            { Lookups.Location
                ...
                , new LookupSetting("WithHolidayAndSunday", "With Holiday And Sunday (Outer Port)", LookupDataType.boolean)
                , new LookupSetting("WithAdditionalForExtension", "With Additional For Extension (Outer Port)", LookupDataType.boolean)
                , new LookupSetting("InternationalLocation", "International Location", LookupDataType.boolean) },
